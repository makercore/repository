...
ifneq ($(shell type -p $(GIT) >/dev/null 2>&1; echo $$?),0)
	$(error $(GIT) not found)
endif

# uses UNIX/POSIX TMPDIR if defined, and falls back to a mktemp-based guessing
